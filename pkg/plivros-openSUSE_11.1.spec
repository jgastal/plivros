...
BuildRequires: DataBaseWrapper-devel RatingWidgetPlugin-devel HoverPushButton-devel libqt4-devel gcc-c++ cmake update-desktop-files
Requires: DataBaseWrapper-devel RatingWidgetPlugin-devel HoverPushButton-devel libqt4
...
mv pkg/plivros-openSUSE_11.1.desktop "$RPM_BUILD_ROOT/%_prefix/share/applications/plivros.desktop"
%suse_update_desktop_file "$RPM_BUILD_ROOT/%_prefix/share/applications/plivros.desktop"
...
do
	...
	chown $user:users /home/$user/.plivros/
	install -g users -o $user -m 644 %_prefix/share/plivros/User.db /home/$user/.plivros/$user.db
done
